...
\begin{redbullet}
    \item Propose des méthodes de passage à l'échelle inspirées du système Dynamo
...
\alert{Serveur}: en deux clics avec Docker.
...
\begin{redbullet}
\item Interpréteur de commandes (\texttt{cqlsh}).
  \item DevCenter (Datastax), le plus agréable, mais il faut s'inscrire...
  \item DBeaver, interface générique basée sur JDBC.
  \item Quelques autres, non testés...
\end{redbullet}
