...
Dans ce qui suit, on suppose que le compte est \texttt{admin/admin}
\end{frame}
...
\begin{minted}{text}
$ curl -X PUT http://admin:admin@localhost:5984/films/doc1 
      -d '{"clef": "valeur"}'
...
\begin{minted}{bash}
curl -X PUT http://admin:admin@localhost:5984/films/us 
...
\begin{minted}{bash}
$ curl -X POST  http://admin:admin@localhost:5984/films/ -d @movie_52.json \
...
\begin{minted}{bash}
$ curl -X PUT http://admin:admin@localhost:5984/films/us -d @newDoc.json 
...
\begin{minted}{bash}
$ curl -X DELETE http://admin:admin@localhost:5984/films/us?rev=2-26863
