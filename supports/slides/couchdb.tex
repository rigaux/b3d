...
\begin{redbullet}
  ...
  \item Le Web est constitué de \alert{ressources}.
   ...
   Très utile (indispensable?): l'outil cURL pour parler le HTTP avec la ligne
      de commande.

   \item Un "message" est une enveloppe dont le contenu est un \alert{document}.
   
   Souvent le document est en HTML (affichage). Mais cela peut être un \alert{document structuré}.
...
\vfill
Beaucoup d'autres services partout\,: \url{http://programmableweb.com}
