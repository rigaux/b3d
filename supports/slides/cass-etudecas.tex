...
\begin{columns}
  ...
  Suppose un nombre limité de visites.
   \end{column}
 \begin{column}{0.45\textwidth}
  Une requête localisée et unique pour trouver toutes les visites d'une Repositorye.
  ...
  \vfill
  Les Repositoryes visitées au moins 10 fois
...
\begin{columns}
  ...
  Avec peu de branches par snapshot
   \end{column}
 \begin{column}{0.45\textwidth}
  Tous les snapshots d'une Repositorye.
...
\begin{columns}
    \begin{column}{0.45\textwidth}
  Ici, vraie structure de graphe. Pas idéal\ldots
