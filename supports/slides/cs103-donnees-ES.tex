...
REST = une définition de services basée sur les standards du Web.
...
\begin{frame}[fragile]{ElasticSearch parle avec nous en HTTP !}

Avec votre navigateur, ouvrez l'URL de votre serveur.
Après connexion, vous devriez obtenir un beau message 
JSON en retour.
...
On envoie un \texttt{PUT} à \url{votre_url/films}
...
On envoie un \texttt{PUT} à \url{votre_url/films/_doc/<id>}
...
Envoyez un POST à l’URL \url{votre_url/\_bulk/} avec le contenu.
\vfill
