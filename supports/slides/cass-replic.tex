...
\section{Distribution \& Réplication}
...
Intuition: il existe un recouvrement entre les réplicas lus et les derniers réplicas écrits, 
de sorte qu'au moins une lecture va accéder à la dernière version.
