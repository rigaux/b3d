...
\begin{redbullet}
  ...
  \item Il n'y a aucune perte d'information
\end{redbullet}
...
\begin{noteblock}
Essentiel en général, avec des exceptions, notamment les données historisées
servant à l'analyse.
\end{noteblock}
...
\begin{noteblock}
Il existe des propriétés formelles pour dire qu'un schéma est normalisé
\end{noteblock}

\end{frame}

\begin{frame}{La modélisation du schéma}

\includegraphics[width=\textwidth]{../figures/cs103_modele}
...
\begin{redbullet}
  ...
  \item Pathologie (\textbf{code}, intitulé, sousTypeDe)
  \item Région (\textbf{code}, nom)
  \item Dépt (\textbf{code}, nom, \textit{codeRégion})
  \item Cas (\textbf{id}, \textit{idPatient}, \textit{codePathologie}, \textit{codeDépt})
\end{redbullet}
...
\begin{redbullet}
  \item la valeur d'une clé primaire est unique
...
\textbf{id} & idPatient & codePathologie & codeDépt \\ \hline
1000  &  10 & epi & 30\\
2000 &  40 & dia & 15\\
3000 &  50 & epi & 30\\
4000 &  10 & neur & 61\\
...
les \alert{incohérences} consécutives aux redondances.
\vfill
Caractéristique\,:
