...
\noindent Chaque \texttt{\textcolor{DarkViolet}{step$i$}} est une expression de la forme \\
...
Ex : \texttt{\textcolor{indiaRed}{child}} ``descend'' sur les enfant, \texttt{\textcolor{indiaRed}{attribut}} ``descend'' sur les attributs.
...
\begin{enumerate}
  \item on consisère un \alert{n{\oe}ud courant}, pris comme point de départ\,;
   ...
   \item on applique à chacun les tests (optionnel)
...
\texttt{\textcolor{red}{\bf /}child::library/child::*/@year}
...
téléchargeable sur \sitepartage/.
} 
}
...
\begin{tiny}
\begin{exampleblock}{Sur le fichier du listing précédent}
