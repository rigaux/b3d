...
\begin{frame}[containsverbatim,fragile]{Notre notion de document, en JSON}
...
Rappel\,: il s'agit d'une \alert{représentaion} d'une structure abstraite
\end{frame}
...
Les documents structurés se caractérisent par les aspects suivants.
