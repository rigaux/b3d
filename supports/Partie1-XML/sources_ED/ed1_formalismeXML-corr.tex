...
\title{CNAM Paris \\ NFE204 - \textit{Bases de données avancées (1)} \\ Travaux dirigés et pratiques \\ Le formalisme XML\\
...
\input{ED1_formalismeXML/contenu_ed_formalismeXML}
\end{document}
