...
\title{ED Cours Bases de données avancées\\
(CNAM Paris, NFE204)\\Publication et transformation de documents XML}
...
\section{Le cours}
Les transparents du cours sont accessibles à l'adresse suivante :\\
 \url{http://http://cedric.cnam.fr/~thionv/MFE204.php}

\section{Exercices}
\input{ED3_XSLT/contenu_ed_XSLT}
\end{document}
