...
.. admonition:: Exercice `Ex-S4-3`_: pesons le loup, le mouton et la bergerie
   ...
   Nous reprenons nos documents de l'exemple `Ex-S3-1`_. Le 
    ...
    .. ifconfig:: rankingS2 in ('public')
      ...
      .. admonition:: Correction
          ...
          #. Les normes: 
             ...
             - A: :math:`\sqrt{1+ 1} = \sqrt{2}`
             - B: :math:`\sqrt{1 + 1} = \sqrt{2}`
             - C: :math:`\sqrt{2^2 + 1 +  1} = \sqrt{6}`         
             - D: :math:`\sqrt{2^2 + 1 +  1 + 1} = \sqrt{7}`     
         ...
         #. Classement (on ne normalise pas la requête car cela n'influe pas sur le classement,
            et du coup on a des cosinus supérieurs à 1): 
             ...
             - loup et pré:
                  ...
                  * A: :math:`\frac{1 + 0 + 0 + 0 +0}{\sqrt{2}} = 0,707`
                  * B: :math:`\frac{0}{\sqrt{2}} = 0`
                  * C: :math:`\frac{2 + 0 + 0 + 0 +0}{\sqrt{6}} = 0,816`
                  * D: :math:`\frac{1 + 0 + 0 + 1 +0}{\sqrt{7}} = 0,755`
             ...
             - loup et mouton:
                 * A: :math:`\frac{1 + 0 + 0 + 0 +0}{\sqrt{2}} = 0,707`
                 * B: :math:`\frac{0 + 1 + 0 + 0 +0}{\sqrt{2}} = 0,707`
                 * C: :math:`\frac{2 + 1 + 0 + 0 +0}{\sqrt{6}} = 1,22`
                 * D: :math:`\frac{1 + 2 + 0 + 0 +0}{\sqrt{7}} = 1,13`
              ...
              - bergerie:
                  * A: :math:`\frac{1}{\sqrt{2}}  = 0,707`
                  * B: :math:`\frac{1}{\sqrt{2}}  = 0,707`
                  * C: :math:`\frac{1}{\sqrt{6}} = 0,4`
                  * D: :math:`\frac{0}{\sqrt{7}}`
              ...
              - gueule du loup:
                  ...
                  * B: :math:`\frac{0}{\sqrt{2}} = 0`
                  * C: :math:`\frac{2 + 0 + 0 + 0 +0}{\sqrt{6}} = 0,816`
                  * D: :math:`\frac{1 + 0 + 0 + 0 +1}{\sqrt{7}} = 0,75`
