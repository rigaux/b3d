...
.. _Ex-S1-3:
.. admonition:: Exercice `Ex-S1-3`_: quelques calculs
...
.. _Ex-S1-4:
.. admonition:: Exercice `Ex-S1-4`_: et avec le réseau?
...
.. _Ex-mapred-1: 
.. admonition:: Exercice `Ex-mapred-1`_: un ``grep``, en MapReduce
...
.. _Ex-mapred-2: 
.. admonition:: Exercice `Ex-mapred-2`_: un ``rollup``, en MapReduce
