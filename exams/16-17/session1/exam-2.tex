...
\title{Sujet d'examen UE NFE204 présentiel -  Session 2}
\author{Année universitaire 2016-2017 -- Examen seconde session: 4 avril  2017}
\date{\empty}
...
\section*{Première partie : questions de cours (3 pts)}
...
\section*{Deuxième partie : documents structurés (6 pts)}
...
\section*{Troisième partie : recherche d'information (6 pts)}
...
\begin{enumerate}
   ...
   \item Donnez une matrice d'incidence contenant les tf, 
      ...
      \emph{Mettez les termes en ligne et les documents en colonne.}
...
\section*{Quatrième partie : MapReduce (5 pts)}
