...
\title{Sujet d'examen UE NFE204 - Présentiel}
\author{Année universitaire 2017-2018}
\date{Examen seconde session: 17 avril 2018}
...
la précision des réponses seront donc appréciées.}
...
\begin{enumerate}
       ...
       \item Est-ce que je peux augmenter le nombre de \textit{shards}\,?
...
\begin{enumerate}
  ...
  \item On effectue une recherche dans un \textit{cluster} ElasticSearch constitué de 10 fragments (primaires), et on veut récupérer
      le résultat par tranches de 10 documents. Combien le coordinateur de la requête
      doit-il récupérer  de documents de chaque 
      fragment au minimum pour constituer un résultat correct pour chaque tranche\,? 
