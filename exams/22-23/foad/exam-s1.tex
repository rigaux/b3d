...
\date{Examen session FOAD\,: 20 juin  2023}
...
{"ref": "hal-875", "titre": "...", "année": 2018, "auteurs": [{"id": "nt", "nom": "...", "affiliation": "..."}, {}, {}]}
...
\item {"organisme": "Vertigo", "membres": [{"ref": "pr", "nom": "Rigaux"}, {"ref":"rsf", "nom": "Fournier", "articles": [{"ref": "hal-875", "titre": ""}]}]}
\item 
...
fonction (art: Article)
for each auteur in art.auteurs: emit (auteur.organisme, art)
\item 
\item fonction reduce (organisme, liste (articles))
for each article in articles:
\item for each membre in article.auteurs:
\item if (membre.organisme == organisme) -> ajouter membre
\item 
...
Les normes
\begin{itemize}
  \item $||A_1|| = \sqrt{2}$; $||A_2|| = \sqrt{2}$; $||A_3|| = \sqrt{4}$;
...
\section*{Troisième partie : systèmes distribués (5 pts)}
