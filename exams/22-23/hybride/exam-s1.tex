...
\hline
Dur\'ee de l'examen : 3h00; En raison du passage en distanciel, pas de limitation sur l'utlisation
des documents. Les exercices sont indépendants les uns des autres. Merci de soigner votre écriture.\\
...
Je vous propose pour finir de commenter 
\href{https://www.elastic.co/guide/en/elasticsearch/guide/current/nested-objects.html}{la partie suivante de la documentation
ElasticSearch}: elle parle des documents structurés et de leur représentation dans le 
cadre d'unn outil de recherche.

Expliquez de la manière la plus concise et précise possible comment ElasticSearch gère
l'imbrication des objets pour ses opérations de recherche.
